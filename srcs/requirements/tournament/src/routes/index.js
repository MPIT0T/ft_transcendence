...
function isClientInAnyRoom(clientId) {
	...
	for (const tournament of tournaments) {
		if ((tournament.clients.some(c => c._clientId === clientId) && tournament.clients.some(c => c.isActive === true)) || (tournament.clients.some(c => c._dbId === joiningClient?._dbId) && tournament.clients.some(c => c.isActive === true))) {
			return true;
		}
	}
	return false;
