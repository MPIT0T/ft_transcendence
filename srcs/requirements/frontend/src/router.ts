...
const routes: Record<string, Page> = {
  ...
  "/stats": Stats,
  "/game-lobby": Lobby,
  "/online-lobby": OnlineLobby,
  "/local-lobby": LocalLobby,
  "/online-game": GameOnline,
  "/online-tournament-game": OnlineTournamentGame,
  "/game-room": GameRoom,
  "/tournament-room": OnlineTournamentRoom,
  "/online-tournament": OnlineTournamentBracket,
  "/local-tournament": LocalTournament,
  "/game": LocalGame,
}
